...
var _elm_lang$elm_architecture_tutorial$HeroesList_View$addSelectedClass = function (bool) {
	return bool ? _elm_lang$html$Html_Attributes$class('selected') : _elm_lang$html$Html_Attributes$class('');
};
var _elm_lang$elm_architecture_tutorial$HeroesList_View$noBubble = {stopPropagation: true, preventDefault: true};
var _elm_lang$elm_architecture_tutorial$HeroesList_View$otherClick = function (message) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		_elm_lang$elm_architecture_tutorial$HeroesList_View$noBubble,
		_elm_lang$core$Json_Decode$succeed(message));
};
var _elm_lang$elm_architecture_tutorial$HeroesList_View$showHero = F2(
	function (hero2, hero) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_elm_lang$elm_architecture_tutorial$HeroesList_Types$SelectHero(hero)),
					_elm_lang$elm_architecture_tutorial$HeroesList_View$addSelectedClass(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$elm_architecture_tutorial$HeroesList_View$otherClick(
							_elm_lang$elm_architecture_tutorial$HeroesList_Types$DeleteHero(hero))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _elm_lang$elm_architecture_tutorial$HeroesList_View$miniDetail = function (maybeHero) {
	var _p0 = maybeHero;
	if (_p0.ctor === 'Just') {
		var _p1 = _p0._0;
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(
							_elm_lang$elm_architecture_tutorial$HeroesList_Types$ViewDetails(_p1))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _elm_lang$elm_architecture_tutorial$HeroesList_View$root = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('text'),
								_elm_lang$html$Html_Events$onInput(_elm_lang$elm_architecture_tutorial$HeroesList_Types$UpdateNewHeroName),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$HeroesList_Types$SaveHero)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				A2(
					_elm_lang$core$List$map,
					_elm_lang$elm_architecture_tutorial$HeroesList_View$showHero(
						A2(
	...
	switch (_p0.ctor) {
		case 'Heroes':
			return A2(
				...
				_elm_lang$elm_architecture_tutorial$HeroesList_View$root(model.heroesListModel));
		case 'Dashboard':
			return A2(
				_elm_lang$html$Html_App$map,
				_elm_lang$elm_architecture_tutorial$App_Types$DashboardT,
				_elm_lang$elm_architecture_tutorial$Dashboard_View$root(model.dashboardModel));
		case 'HeroDetails':
...
var _elm_lang$elm_architecture_tutorial$HeroesList_Rest$deleteHero = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		_elm_lang$elm_architecture_tutorial$HeroesList_Types$DeleteHeroFail,
		_elm_lang$elm_architecture_tutorial$HeroesList_Types$DeleteHeroSucceed,
		_elm_lang$elm_architecture_tutorial$App_Rest$delete(url));
};
var _elm_lang$elm_architecture_tutorial$HeroesList_Rest$saveHero = F2(
	function (hero, url) {
		return A3(
			_elm_lang$core$Task$perform,
			_elm_lang$elm_architecture_tutorial$HeroesList_Types$SaveHeroFail,
			_elm_lang$elm_architecture_tutorial$HeroesList_Types$SaveHeroSucceed,
			A2(_elm_lang$elm_architecture_tutorial$App_Rest$post, url, hero));
	});

var _elm_lang$elm_architecture_tutorial$HeroesList_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UpdateNewHeroName':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							newHeroName: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SelectHero':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							selectedHero: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'ViewDetails':
				...
				if (_p1.ctor === 'Just') {
					return A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$elm_architecture_tutorial$HeroesList_Rest$saveHero,
								A2(_elm_lang$elm_architecture_tutorial$Hero_Types$Hero, 0, _p1._0),
								'http://localhost:3000/heroes')
							]));
				} else {
					return A2(
			...
			case 'SaveHeroSucceed':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{heroesList: newList, newHeroName: _elm_lang$core$Maybe$Nothing}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SaveHeroFail':
				return A2(
			...
			case 'DeleteHero':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$elm_architecture_tutorial$HeroesList_Rest$deleteHero(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'http://localhost:3000/heroes/',
								_elm_lang$core$Basics$toString(_p0._0.id)))
...
var _elm_lang$elm_architecture_tutorial$HeroesList_State$init = function () {
	var model = {
		newHeroName: _elm_lang$core$Maybe$Nothing,
		selectedHero: _elm_lang$core$Maybe$Nothing,
		heroesList: _elm_lang$core$Native_List.fromArray(
...
var _elm_lang$elm_architecture_tutorial$App_State$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'HeroesList':
				var _p3 = A2(_elm_lang$elm_architecture_tutorial$HeroesList_State$update, _p1._0, model.heroesListModel);
				var newModel = _p3._0;
				var newCmd = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{heroesListModel: newModel}),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$elm_architecture_tutorial$App_Types$HeroesList, newCmd)
						]));
			case 'DashboardT':
				var _p4 = A2(_elm_lang$elm_architecture_tutorial$Dashboard_State$update, _p1._0, model.dashboardModel);
				var newModel = _p4._0;
				var newCmd = _p4._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var Elm = {};
Elm['App'] = Elm['App'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['App'], 'App', typeof _elm_lang$elm_architecture_tutorial$App$main === 'undefined' ? null : _elm_lang$elm_architecture_tutorial$App$main);
